...
use sfml::window::{mouse, Event, Key, Style};
...
fn main() {
    ...
    // game states
    let scale = 4; // defines grid size. 1 to smallest_dimension
    let step = 5;
    ...
    cell.set_fill_color(&Color::rgb(137, 165, 150));
